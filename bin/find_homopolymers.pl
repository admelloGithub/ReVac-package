...
find_homopolymers.pl - Find homopolymeric tracts in a sequence file.
			--Initially designed by D.Riley for single sequence fasta files. Modded to run multi sequence fasta files.
...
open my $fh, "<$seqfile" or die "Unable to open input file $seqfile\n";;
