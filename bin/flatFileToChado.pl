...
USAGE:  flatFileToChado.pl -D database [-O outfile]  -P password [-S server] -U username [-f /path/to/password.file] [--bcp_ext] -b bcpmode --database_type [-d debug_level] [-h] [--ignore_empty_bcp] [-i infile] [-l logfile] [-m] [-n nodie] [-o directory] [-s batchsize] [-t table] [-u noupdatestats] [-z testmode] [-Z tgz]
...
my ($username, $password, $database, $server, $pass_file,
...
sub printUsage {
    ...
    "  -P|--password           = password\n".
    "  -f|--password_file	= Optional - provide password in a file\n".
