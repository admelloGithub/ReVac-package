...
USAGE:  checkForDuplicatePropertyTuples.pl --database --database_type [--debug_level] [-h] [--logfile] [-m] --password [--password_file] --server --table --username
...
my ($database, $database_type, $debug_level, $help, $logfile, $man, $password,
    $server, $table, $username, $pass_file);
